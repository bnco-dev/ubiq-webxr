...
namespace Ubiq.XR
{
    ...
    public class CameraOffsetter : MonoBehaviour
    {
        ...
        public GameObject cameraFloorOffsetObject { get { return m_CameraFloorOffsetObject; } set { m_CameraFloorOffsetObject = value; } }
        ...
        public UserRequestedTrackingMode requestedTrackingMode { get { return m_RequestedTrackingMode; } set { m_RequestedTrackingMode = value; } }
        ...
        public TrackingOriginModeFlags TrackingOriginMode { get { return m_TrackingOriginMode; } set { m_TrackingOriginMode = value; } }
#endif
...
#endif
        public TrackingSpaceType trackingSpace { get { return m_TrackingSpace; } set { m_TrackingSpace = value; } }
...
// // Port of CameraOffset from XR Legacy Input Helpers.
...
//             {
//                 // Ubiq starts
//                 // No subsystems found, so we're either looking at an
//                 // unsupported VR system or no VR system at all (desktop)
//                 // For desktop, all we need to do is raise the camera
//                 if (m_CameraFloorOffsetObject)
//                 {
