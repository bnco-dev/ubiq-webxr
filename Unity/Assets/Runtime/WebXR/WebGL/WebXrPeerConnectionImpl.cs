...
{
    public class WebXrPeerConnectionImpl : IPeerConnectionImpl {
        ...
        {
            return new VoipAudioSourceOutput.Stats
            {
        ...
        {
            JS_WebRTC_SetPanner(peerConnectionId,position.x,position.y,position.z);
        }
        // debug setremote
